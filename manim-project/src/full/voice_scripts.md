...
“Thay vì ép từng user phải match một-một, soft matching cho phép mỗi user liên kết với nhiều user khác với các mức độ khác nhau. 

Thay vì một mapping rời rạc, chúng ta có một phân phối xác suất. Điều này giúp mô hình linh hoạt hơn và cho phép tối ưu bằng gradient descent. Quan trọng hơn, nó mở đường cho việc sử dụng các phương pháp dựa trên optimal transport.”
...
Chính vì vậy, Wasserstein distance mang lại một cách nhìn hoàn toàn khác: thay vì so sánh trực tiếp từng điểm, ta đo chi phí để ‘biến đổi’ một phân phối thành phân phối còn lại, từ đó giúp việc tối ưu trở nên ổn định hơn.”

“Dựa trên ý tưởng đó, Sinkhorn distance được sử dụng như một phiên bản thực tiễn và hiệu quả hơn, giúp tính toán gần đúng Wasserstein distance trong khi vẫn đảm bảo tính differentiable để tích hợp vào quá trình huấn luyện.”

## KẾT

“Tóm lại, ngay cả khi không có bất kỳ overlap nào giữa các domain, chúng ta vẫn có thể học được mối liên hệ giữa chúng. Bằng cách tập trung vào sở thích thay vì danh tính, và bằng cách sử dụng geometry của không gian embedding, mô hình có thể vượt qua những hạn chế của dữ liệu phân mảnh. Đây không chỉ là một giải pháp cho recommendation, mà còn là một hướng tiếp cận mạnh mẽ trong representation learning hiện đại.”
