#!/usr/bin/env python3
"""Main entry point for running GAN-based oversampling pipeline."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run GAN-based oversampling on CIFAR-10-LT",
    )
    parser.add_argument(
        "--config",
        type=Path,
        default=Path("configs/gan.yaml"),
    ...
    print("\n" + "=" * 50)
    print("GAN-BASED OVERSAMPLING RESULTS")
    print("=" * 50)
