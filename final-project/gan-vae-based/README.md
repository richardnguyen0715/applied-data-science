...
```bibtex
@software{cifar10lt_gan_vae_2026,
  title = {CIFAR-10-LT Imbalance Learning with GAN and VAE},
  author = {Your Name},
  year = {2026},
  url = {https://github.com/yourusername/cifar10-lt-gan-vae}
}
```

## References

- Mirza & Osindski (2014): Conditional Generative Adversarial Nets
- Kingma & Welling (2013): Auto-Encoding Variational Bayes
- He et al. (2020): Decoupling Representation and Classifier for Long-Tailed Recognition
...
2. Review [Troubleshooting](docs/usage.md#debugging--troubleshooting)
